...
In this task, I demonstrated my proficiency in Python object-oriented programming by
developing three interrelated classes that embody rectangles and squares.
I created a customized test suite utilizing the unittest module to verify all features
for each class.
